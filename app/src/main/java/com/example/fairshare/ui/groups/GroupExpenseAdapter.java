...
public class GroupExpenseAdapter extends ListAdapter<GroupExpense, GroupExpenseAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(GroupExpense expense) {
            ...
            tvPaidBy.setText("Recorded by " + (expense.getPayerName() != null ? expense.getPayerName() : "Unknown"));
            int contributorCount = expense.getContributorCount();
            if (contributorCount > 0) {
                tvSplitInfo.setText("Includes " + contributorCount + " member contributions");
            } else {
                tvSplitInfo.setText("Counts as this member's equity contribution");
            }
            tvAmount.setText(String.format("₱%,.2f", expense.getContributionTotal()));
        }
    }
}
